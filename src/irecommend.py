...
def parse_div(div):  # Функция разбора таблицы с вопросом
    ...
    r = requests.get(review_link, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.102 Safari/537.36 OPR/71.0.3770.171'})
...
def simple_request():
    ...
    for i in range(9, max_page, 1):
        if i == 0:
            ...
            url = 'https://irecommend.ru/taxonomy/term/938/reviews?page=%d&tid=%d' % (i, site_id)  # url страницы
        print(url)
